...
class My_special_events_list extends WP_List_Table
{
    function __construct()
    {
        ...
        parent::__construct(array(
            'singular' => __('special event', 'mylisttable'),
            'plural' => __('special events', 'mylisttable'),
            'ajax' => false
        ));
        add_action('admin_head', array($this, 'admin_header_special_events'));
    }
    ...
    function column_submission_id_special_events($item)
    {
    ...
    function admin_header_special_events()
    {
     ...
     * @return array
     */
    public function get_bulk_actions_special_events()
    {
        $actions = [
    ...
    function usort_reorder_special_events($a, $b)
    {
...
// Send final sort direction to usort
    ...
    function prepare_items_special_events()
    {
        ...
        /** Process bulk action */
        $this->process_bulk_action_special_events();
    }
...
// filter the table data based on the search key
    ...
    function get_sortable_columns_special_events()
    {
    ...
    public function process_bulk_action_special_events()
    {
