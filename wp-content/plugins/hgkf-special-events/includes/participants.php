...
class participants_special_events_list  extends WP_List_Table
{
...
// Send final sort direction to usort
    ...
    function prepare_special_events_participants()
    {
    ...
    public static function record_count()
    {
        ...
        $sql = "SELECT COUNT(*) FROM {$wpdb->prefix}special_events_participants";
    ...
    public static function get_participants($per_page = 100, $page_number = 1)
    {
        ...
        $sql = "SELECT * FROM {$wpdb->prefix}special_events_participants";
