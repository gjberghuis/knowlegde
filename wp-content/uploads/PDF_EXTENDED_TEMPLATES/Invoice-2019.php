...
/*
 * Template Name: Factuur template 2019
 * Version: 1.0
 * Description: Een template voor een factuur van een aanmelding voor het Grootste Kennisfestival van Nederland
    ...
    <div class="price">
        <table>
            ...
            <tr>
                ...
                <td align="right">0 %</td>
                <td align="right">€ <?php echo $payment_details[0]->food_fee_total ?></td>
            </tr>
            <?php if($payment_details[0]->membership_fee && $payment_details[0]->membership_fee > 0) : ?>
            <tr>
                <td>Lidmaatschap</td>
                <td align="right">1,00</td>
                <td align="right">€ <?php echo $payment_details[0]->membership_fee ?></td>
                <td align="right">21 %</td>
                <td align="right">€ <?php echo $payment_details[0]->membership_fee_total ?></td>
            </tr>                
            <?php endif; ?>
            ...
            <tr>
                ...
                <td align="right">21 %</td>
                <td align="right">€ <?php echo $payment_details[0]->parking_fee_total  ?></td>
            </tr>
            <?php endif; ?>
        </table>
    </div>
